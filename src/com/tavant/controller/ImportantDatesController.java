...
public class ImportantDatesController {
	...
	public ModelAndView addAnniversaryForm(HttpServletRequest request, ModelMap model) {
		if(request.getSession().getAttribute("currentUser") == null) {
			return new ModelAndView("master");
		}
	...
	public ModelAndView onSubmit(@ModelAttribute("anniversary") Anniversary anniversary,BindingResult result, SessionStatus status,
	...
	public ModelAndView deleteAnniversary(HttpServletRequest request, ModelMap model)
		...
		anniversaryService.deleteAnniversary(new Anniversary(anniversaryId, userId));
